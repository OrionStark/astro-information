...
export class NeoInformationComponent implements OnInit, AfterViewInit {
  ...
  constructor( private _activeRoute: ActivatedRoute, private _nasaService: NasaService ) {
    ...
    this._nasaService.getNEOLookUp(param)
      .subscribe(
        data => {
          ...
          this.dataSource = new MatTableDataSource<any>(json_data.close_approach_data);
